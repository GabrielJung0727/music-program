            ...
            <div style={{ padding: "16px 20px 10px" }}>
              ...
              <div className="queue-now-playing-card" style={{
                ...
                <div style={{
                  ...
                  <img src={albumArt(currentTrack.art || (currentTrack as any).coverUrl || FALLBACK_ART)} alt={currentTrack.album} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                </div>
                  ...
                  <div key={track.id}>
                    ...
                    >
                      ...
                      <div style={{
                        ...
                        <img src={albumArt(track.art || (track as any).coverUrl || FALLBACK_ART)} alt={track.album} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                      </div>
